<template>
    <footer v-if="footer">
                            ...
                            <b-col sm="4" v-for="item in footer.MenuFooter" :key="item.id">
                                <div class="footer-widget">
                                    ...
                                    <ul class="footer-widget__link" v-if="item.MenuItem">
                                        <li v-for="item1 in item.MenuItem" :key="item1.id">
                                            <a :href="item1.UrlItem">{{ item1.TitleItem }}
                                            </a>
                                        </li>
                                    </ul>
                                </div>
        ...
        <div class="social-icon1">
            <a :href="'tel:' + footer.SocialMedia?.Hotline" aria-label="gọi điện cho chúng tôi">
                <img src="../assets/images/phone.png" alt="">
            </a>
            <a :href="footer.SocialMedia?.UrlZalo" target="_blank" aria-label="liện hệ qua zalo">
                <img src="../assets/images/zalo.png" alt="">
            </a>
            <a :href="footer.SocialMedia?.UrlMess" target="_blank" aria-label="liện hệ qua messeger">
