<template>
    <footer v-if="footer">
        ...
        <div class="social-icon1">
            <a :href="'tel:' + footer.SocialMedia?.Hotline">
                <img src="../assets/images/phone.png" alt="">
            </a>
            <a :href="footer.SocialMedia?.UrlZalo" target="_blank">
                <img src="../assets/images/zalo.png" alt="">
            </a>
            <a :href="footer.SocialMedia?.UrlMess" target="_blank">
                <svg width="30" height="30" viewBox="0 0 36 36" data-v-6882cb11="">
                    <path fill="white"
