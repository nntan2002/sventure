                                                                ...
                                                                <tr>
                                                                    <td class="es-m-p0r esd-container-frame" width="560" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-image" style="font-size: 0px;"><a target="_blank"><img class="adapt-img" src="https://fbgnjln.stripocdn.email/content/guids/CABINET_ffec2833c103c249703000a8d5fb336d14f319c180cdc60ba6c761a1f0bf2ae1/images/logosventure01.png" alt style="display: block;" width="250"></a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-text es-p15">
                                                                                        <p style="font-size: 20px;"><strong>Thông tin liên hệ mới</strong></p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text">
                                                                                        ...
                                                                                        <p>Tên công ty: ${YourCompanyName}</p>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-button">
                                                                                        <!--[if mso]><a href="tel:${Phone}" target="_blank" hidden>
...
<![endif]-->
                                                                                        <!--[if !mso]><!-- --><span class="msohide es-button-border" style="border-radius: 0px;"><a href="tel:${Phone}" class="es-button" target="_blank" style="border-radius: 0px">Gọi điện ngay</a></span>
                                                                                        <!--<![endif]-->
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
